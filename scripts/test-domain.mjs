...
const MODULOS = ["domain", "importer", "seed", "contagiro", "reporting", "traducao", "repositorio", "carteira", "certificado", "serpro-formato", "nfse/dps", "nfse/assinatura", "nfse/abrasf", "pgdas", "openfinance"];
const LOCAIS = /(['"])\.\/(domain|contagiro|reporting|traducao|repositorio|carteira|certificado|serpro-formato|dps|assinatura|abrasf|pgdas|openfinance)\1/g;
...
const testes = ["domain", "contagiro", "traducao", "carteira", "serpro", "nfse", "pgdas", "webiss", "openfinance", "estilos"].map((t) => `tests/${t}.test.mjs`);
